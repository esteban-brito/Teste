...
const CONFIG={BASE:.592,W_EK:.385,W_SURV:.160,W_KAST:.240,W_MULTI:.042,W_SWING:.10,PESO_MORTE:.95,PESO_OPEN:.216,
...
export function fallenAngelsComponents(event){
  ...
  const prior=Math.max(C.PRIOR.min,Math.min(C.PRIOR.max,((event.ratingBase??C.PRIOR.ref)-C.PRIOR.ref)*C.PRIOR.per));
