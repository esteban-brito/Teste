/* bancada/ferramentas/classificacao.js — o medidor da reformulação de funções e playstyles.
   ...
   Uso:  node bancada/ferramentas/classificacao.js
         CLASSIFICACAO_LIMITE=20 node bancada/ferramentas/classificacao.js   (limite acordado com o dono)
         node bancada/ferramentas/classificacao.js --frageis 20              (lista os N mais frágeis) */
const fs=require("fs");
const path=require("path");
const {X}=require("../lib/motor");
const {GOLDEN,mean,okMark}=require("../lib/common");
