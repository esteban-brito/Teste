/* bancada/campaign-golden-update.js - regenera bancada/campaign-golden.json.

   O fixture trava a campanha MD3 do sandbox por seed fixa e é verificado por
   bancada/e2e-simulation.js. Ele NÃO tem atualização automática de propósito: só
   ...
   Uso: node bancada/campaign-golden-update.js */
const fs=require("fs");
const http=require("http");
const path=require("path");
const {spawn}=require("child_process");
const {chromium}=require("playwright");
const {chromiumLaunchOptions}=require("./common");

const FIXTURE_PATH=path.join(__dirname,"campaign-golden.json");
