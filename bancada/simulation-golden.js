...
function buildCurrent(){
  const current={
    ...
    scenarios:[
      fixedMapScenario({id:"economy-and-clutches",seed:1,aIndex:0,bIndex:1,map:"Nuke",expectedScore:[9,13]}),
      fixedMapScenario({id:"repeated-overtime",seed:21,aIndex:0,bIndex:1,map:"Nuke",expectedScore:[19,17]}),
