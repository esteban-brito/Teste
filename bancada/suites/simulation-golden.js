/* bancada/suites/simulation-golden.js - caracteriza o simulador atual por seed.
   O fixture protege comportamento observavel; nao declara que o balanceamento atual e ideal.

   Uso: node bancada/suites/simulation-golden.js
        node bancada/suites/simulation-golden.js --update */
const assert=require("node:assert/strict");
const fs=require("node:fs");
const path=require("node:path");
const {loadEngines,buildCombatTeams}=require("../lib/motor");
const {GOLDEN,okMark}=require("../lib/common");

const FIXTURE_PATH=path.join(GOLDEN,"simulation-golden.json");
...
function campaignSeriesScenario(){
  // Seed 3: a única razão de este cenário existir é exercitar o MAPA DECISIVO, que uma varrida
  // 2-0 nunca alcança. A 3 devolve a série 1-2 em três mapas.
