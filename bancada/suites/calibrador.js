/* bancada/suites/calibrador.js - suíte funcional rápida do calibrador real. */
const fs=require("fs");
const path=require("path");
const {ROOT,okMark}=require("../lib/common");
const {loadCalibrator}=require("../lib/calibrador-loader");
