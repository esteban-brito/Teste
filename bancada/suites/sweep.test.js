/* bancada/suites/sweep.test.js — contratos do harness de varredura e do intervalo de proporção.
...
const {scheduledMatch}=require("../lib/common");
const {varrer,controle,dentroDaFaixa,margemNaFaixa,valorDe,textoMetrica}=require("../lib/sweep");
