/* bancada/suites/r5-comparison.js - contratos da captura e comparacao pareada R5. */
...
async function main(){
  const statistics=await import(pathToFileURL(path.join(ROOT,"src","domain","statistics","paired-comparison.mjs")).href);
