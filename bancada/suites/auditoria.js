/* bancada/suites/auditoria.js - relatorio curto de classificacao e auditoria profunda do simulador.
   Uso: node bancada/suites/auditoria.js
        node bancada/suites/auditoria.js --deep [--format human|json] [--cycles 8] */
...
function buildDeepAuditSync(cycles=DEFAULT_DEEP_CYCLES,options={}){
  ...
  const report={
    ...
    passFailThresholds:[],
    method:{
      source:"src/public/simulation-api.mjs via bancada/lib/motor.js",rngContract:"mulberry32-v1",baseSeed:DEEP_BASE_SEED,
...
function usage(){
  console.log("Uso:");
  console.log("  node bancada/suites/auditoria.js");
  console.log("  node bancada/suites/auditoria.js --deep [--format human|json] [--cycles 8]");
...
async function main(args=process.argv.slice(2)){
  ...
  if(options.mode==="quick"){
    const evaluationPath=path.join(ROOT,"src","domain","evaluation");
