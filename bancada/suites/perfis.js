/* bancada/suites/perfis.js - coerência de CARTA: o rating de um jogador tem que emergir de
   ...
   o GATE de qualidade individual, e bancada/suites/rating.js virou relatório. */
const {X,T}=require("../lib/motor");
const {mean,inRange,printCheck,scheduledMatch}=require("../lib/common");
