...
- [`docs/testing.md`](docs/testing.md): 15 suítes e comandos por camada;
...
| `run.js` | Roda as 15 suítes; aceita grupos de dados, regressão, calibrador, benchmark, fidelidade e E2E |
